...
(function () {
  ...
  const DICTIONARY = {
    ms: {
      ...
      "Banned Items": "Item Dilarang",
      "Banned Item List": "Senarai Item Dilarang",
      "Competitive Rules": "Peraturan Kompetitif",
      "BR and Multiplayer restrictions.": "Sekatan BR dan Multiplayer.",
      "Search and filter the restricted items by mode and category before match day.": "Cari dan tapis item yang disekat mengikut mod dan kategori sebelum hari perlawanan.",
      "View List": "Lihat Senarai",
      "Search & Categories": "Carian & Kategori",
      "Find Restricted Items": "Cari Item Dilarang",
      "Use search for exact item names, or filter by mode and category.": "Gunakan carian untuk nama item yang tepat, atau tapis mengikut mod dan kategori.",
      "All Categories": "Semua Kategori",
      "Category": "Kategori",
      "Search item, weapon, attachment, perk...": "Cari item, senjata, aksesori, perk...",
    ...
    fil: {
      ...
      "Banned Item List": "Banned Item List",
      "Competitive Rules": "Competitive Rules",
      "BR and Multiplayer restrictions.": "BR at Multiplayer restrictions.",
      "Search and filter the restricted items by mode and category before match day.": "Hanapin at i-filter ang restricted items ayon sa mode at category bago ang match day.",
      "View List": "Tingnan ang Listahan",
      "Search & Categories": "Search at Categories",
      "Find Restricted Items": "Hanapin ang Restricted Items",
      "Use search for exact item names, or filter by mode and category.": "Gamitin ang search para sa exact item names, o mag-filter ayon sa mode at category.",
      "All Categories": "Lahat ng Categories",
      "Category": "Category",
      "Search item, weapon, attachment, perk...": "Search item, weapon, attachment, perk...",
    ...
    zh: {
      ...
      "Rulebook": "规则手册",
      "Banned Items": "禁用物品",
      "Banned Item List": "禁用物品列表",
      "Competitive Rules": "竞技规则",
      "BR and Multiplayer restrictions.": "BR 与多人模式限制。",
      "Search and filter the restricted items by mode and category before match day.": "赛前按模式与类别搜索和筛选禁用项目。",
      "View List": "查看列表",
      "Search & Categories": "搜索与分类",
      "Find Restricted Items": "查找禁用项目",
      "Use search for exact item names, or filter by mode and category.": "使用搜索查找具体项目名称，或按模式与类别筛选。",
      "All Categories": "所有类别",
      "Category": "类别",
      "Search item, weapon, attachment, perk...": "搜索物品、武器、配件、技能...",
      "FAQ & Support": "常见问题与支持",
